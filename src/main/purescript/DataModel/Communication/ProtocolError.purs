...
instance showProtocolError :: Show ProtocolError where
  ...
  show (MaxPinAttemptsReachedError) = "Max PIN Attempts Reached"
...
instance prettyShowProtocolError :: PrettyShow ProtocolError where
  ...
  prettyShow (MaxPinAttemptsReachedError) = "You have entered a wrong PIN for three times, you need to login with credentials to be able to use the PIN again."
  ...
  prettyShow  UnauthorizedError           = "Unauthorized"
